        ...
        <nav class="relative max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8"
            ...
            <div id="navbar-collapse-with-animation"
                ...
                <div
                    ...
                    <a class="font-medium text-gray-300 hover:text-gray-400 sm:py-6" href="{{ route('home') }}">Home</a>
                    <a class="font-medium text-gray-50 sm:py-6" href="{{ route('aboutus') }}" aria-current="page">About
                        Us</a>
